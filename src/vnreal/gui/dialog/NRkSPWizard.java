...
public class NRkSPWizard extends AbstractButtonDialog implements
	...
	public NRkSPWizard(Scenario scenario) {
	...
	protected void doAction() {
		...
		IAlgorithm NodeRankingKShortestPaths = null;
		...
		if (!yesIsDistanceButton.isSelected()
			...
			NodeRankingKShortestPaths = new NodeRankingKShortestPaths(ns, k, distance, true,
					true);
		} else if (yesIsDistanceButton.isSelected()
				&& noNodeOverloadButton.isSelected()) {
			NodeRankingKShortestPaths = new NodeRankingKShortestPaths(ns, k, distance, true,
				...
				&& yesNodeOverloadButton.isSelected()) {
			NodeRankingKShortestPaths = new NodeRankingKShortestPaths(ns, k, 0, false, true);
		} else if (noIsDistanceButton.isSelected()
				&& noNodeOverloadButton.isSelected()) {
			NodeRankingKShortestPaths = new NodeRankingKShortestPaths(ns, k, 0, false, false);
		}
		new MyProgressBarDialog(NodeRankingKShortestPaths, scenario);
