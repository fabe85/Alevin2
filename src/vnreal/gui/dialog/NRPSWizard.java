...
public class NRPSWizard extends AbstractButtonDialog
	...
	public NRPSWizard(Scenario scenario) {
	...
	protected void doAction() {
		...
		IAlgorithm NodeRankingPathSplitting = null;
		...
		if (!yesIsDistanceButton.isSelected()
			...
			NodeRankingPathSplitting = new NodeRankingPathSplitting(
		...
		new MyProgressBarDialog(NodeRankingPathSplitting, scenario);
