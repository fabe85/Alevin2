...
import mulavito.graph.generators.WaxmanGraphGenerator2;
...
public class FixedWaxmanNetworkGenerator2 extends AbstractNetworkGenerator{
        @Override
        public NetworkStack generate(ArrayList<Object> parameters) {
                ...
                List<VirtualNetwork> vns = createVirtualNetworks(alpha, beta, numVNets, numVNodesPerNet, seed);
        ...
        protected SubstrateNetwork createSubstrateNetwork(Double alpha, Double beta, Integer sNetSize, Long seed) {
                ...
                WaxmanGraphGenerator2<SubstrateNode, SubstrateLink> sGenerator = new WaxmanGraphGenerator2<SubstrateNode, SubstrateLink>(
        ...
        protected List<VirtualNetwork> createVirtualNetworks(Double alpha,
                ...
                WaxmanGraphGenerator2<VirtualNode, VirtualLink> vGenerator = new WaxmanGraphGenerator2<VirtualNode, VirtualLink>(
                                alpha, beta, false, seed);
