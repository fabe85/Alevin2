...
public final class BFSCoordinatedVNETest extends AbstractScenarioTest<ScenarioData, TestConfiguration> {

	private static final int k = 50, dist = 35;

	public BFSCoordinatedVNETest(TestConfiguration c, String name) {
		super(c, name, false);
	}
	...
	public static void main(String[] args) throws IOException {
		...
		new BFSCoordinatedVNETest(new TestConfiguration(), "BFSCoord").executeTest();
	}
