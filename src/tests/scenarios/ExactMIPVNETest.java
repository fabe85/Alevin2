...
import vnreal.algorithms.ExactMipAlgorithmWithHiddenHops;
...
public final class ExactMIPVNETest extends AbstractScenarioTest<ScenarioData, TestConfiguration> {

	private static final int wCpu = 0, wBw = 0, dist = 35;

	public ExactMIPVNETest(TestConfiguration c, String name) {
		super(c, name, false);
	}
	...
	protected void runAlgorithm(NetworkStack stack, ScenarioData data) {
		...
		IAlgorithm algo = new ExactMipAlgorithmWithHiddenHops(stack, wCpu, wBw,
				dist, false, false);
	...
	public static void main(String[] args) throws IOException {
		...
		new ExactMIPVNETest(new TestConfiguration(), "ExactMIP").executeTest();
	}
}
