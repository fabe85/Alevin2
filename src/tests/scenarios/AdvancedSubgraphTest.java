...
public final class AdvancedSubgraphTest extends AbstractScenarioTest<ScenarioData, TestConfiguration> {

	public AdvancedSubgraphTest(TestConfiguration c, String name) {
		super(c, name, false);
	}
	...
	public static void main(String[] args) throws IOException {
		new AdvancedSubgraphTest(new TestConfiguration(), "Subgraph").executeTest();
	}
