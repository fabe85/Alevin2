...
public final class DViNEPSTest extends AbstractScenarioTest<ScenarioData, TestConfiguration> {

	private static final int wCpu = 0, wBw = 0, type = 0, dist = 35;

	public DViNEPSTest(TestConfiguration c, String name) {
		super(c, name, true);
	}
	...
	public static void main(String[] args) throws IOException {
		...
		new DViNEPSTest(new TestConfiguration(), Class.class.getName()).executeTest();
	}
