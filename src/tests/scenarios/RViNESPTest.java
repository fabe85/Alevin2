...
public class RViNESPTest extends AbstractScenarioTest<ScenarioData, TestConfiguration> {
	
	public RViNESPTest(TestConfiguration c, String name) {
		super(c, name, false);
	}
	...
	public static void main(String[] args) throws IOException {
		...
		new RViNESPTest(new TestConfiguration(), "RViNESP").executeTest();
	}
