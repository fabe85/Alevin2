...
public final class RWMMSPTest extends AbstractScenarioTest<ScenarioData, TestConfiguration> {

	private static final int k = 50, dist = 35;

	public RWMMSPTest(TestConfiguration c, String name) {
		super(c, name, false);
	}
	...
	public static void main(String[] args) throws IOException {
		...
		new RWMMSPTest(new TestConfiguration(), "RW-MM-SP").executeTest();
	}
}
