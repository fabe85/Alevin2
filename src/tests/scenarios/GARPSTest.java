...
public final class GARPSTest extends AbstractScenarioTest<ScenarioData, TestConfiguration> {

	private static final int wCpu = 0, wBw = 0, dist = 35;

	public GARPSTest(TestConfiguration c, String name) {
		super(c, name, true);
	}
	...
	public static void main(String[] args) throws IOException {
		...
		new GARPSTest(new TestConfiguration(), "AvailResourcePS").executeTest();
	}
}
