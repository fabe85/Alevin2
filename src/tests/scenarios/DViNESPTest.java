...
public final class DViNESPTest extends AbstractScenarioTest<ScenarioData, TestConfiguration> {

	private static final int wCpu = 0, wBw = 0, k = 50, type = 0, dist = 35;

	public DViNESPTest(TestConfiguration c, String name) {
		super(c, name, false);
	}
	...
	public static void main(String[] args) throws IOException {
		...
		new DViNESPTest(new TestConfiguration(), "CoordKSP").executeTest();
	}
}
